...
**The Cheshire (6300 Clayton Rd, St. Louis, MO 63117)**. Standard King Suite and Standard Queen $155 per night. The current tax rates are 9.238% (state) and 7.25% (occupancy). Tax rates are subject to change. Guests will use the booking link https://reservations.travelclick.com/98391?groupID=3911259 to make reservations. In order to be included in the block one must make reservations by **05/26/23**.
